...
Tic counts before -> after: inline ", not X" 3 -> 0; "rather than" 1 -> 0; "precisely" 2 -> 0 (one literal "known exactly" remains); sentence-initial "This is" 4 -> 1; aphoristic lines removed ("The apparent improvement is missing work."; "Here the system's apparent competence depends on which of them the evaluator remembers to ask.").
